...
import (
	...
	ethChain "github.com/Privi-Protocol/ChainBridge/chains/ethereum"
	subChain "github.com/Privi-Protocol/ChainBridge/chains/substrate"
	eth "github.com/Privi-Protocol/ChainBridge/e2e/ethereum"
	sub "github.com/Privi-Protocol/ChainBridge/e2e/substrate"
	"github.com/Privi-Protocol/ChainBridge/shared"
...
func Test_ThreeRelayers(t *testing.T) {
	...
	subtest.QueryConst(t, subClient, "ChainBridgeHandler", "NativeTokenId", &rawRId)
	subErc20ResourceId := msg.ResourceIdFromSlice(rawRId[:])
	subtest.QueryConst(t, subClient, "ChainBridgeHandler", "Erc721Id", &rawRId)
	subErc721ResourceId := msg.ResourceIdFromSlice(rawRId[:])
	subtest.QueryConst(t, subClient, "ChainBridgeHandler", "HashId", &rawRId)
